    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                BluetoothGattCharacteristic ale =getGattService().getCharacteristic(UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb"));
...
//    byte[] WriteBytes = new byte[20];
    public void sendString(String g){
        g=""+g;
//        WriteBytes= hex2byte(g.toString().getBytes());
//        WriteBytes = Utils.hexToReversedByteArray(g);
        ...
        //byte t[]={51,1,2};
        gg.setValue(Utils.hexToReversedByteArray(g));
        mBluetoothGatt.writeCharacteristic(gg);

    }
    public void setPz(String g){
        g=""+g;
//        WriteBytes= hex2byte(g.toString().getBytes());

        BluetoothGattCharacteristic gg;
        List<BluetoothGattCharacteristic> characteristics = mBluetoothGatt.getService(UUID.fromString(Service_uuid)).getCharacteristics();
        List<BluetoothGattService> services = mBluetoothGatt.getServices();
        for (BluetoothGattService service:services){
            Log.i(TAG, "setPz1: "+service.getUuid());
        }
        for (int i = 0; i < characteristics.size(); i++) {
            Log.i(TAG, "setPz: "+characteristics.get(i).getUuid());
        }
//        gg=mBluetoothGatt.getService(UUID.fromString(Service_uuid)).getCharacteristic(UUID.fromString(Characteristic_uuid_GN));
//        //byte t[]={51,1,2};
