...
public class PermissionHelper {
	...
	private final static int ACCESS_FINE_LOCATION = 102;
	...
	private PermissionModel[] mPermissionModels = new PermissionModel[] {
			new PermissionModel("位置", Manifest.permission.ACCESS_COARSE_LOCATION, "我们需要读取手机位置的权限来展示附近的设备", ACCESS_COARSE_LOCATION),
			new PermissionModel("位置", Manifest.permission.ACCESS_FINE_LOCATION, "我们需要读取手机位置的权限来展示附近的设备",
